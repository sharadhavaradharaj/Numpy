...
step_two_array = np.arange(0, 111, 10).reshape(3, 4)
...
print("The shape in step 1 is 4*3, but the shape in step two is 3*4, the elements will not match to multiply array 1 and array2")
...
## this worked! why?
print("The dimensions of the array matches in array 1 and array 3")
